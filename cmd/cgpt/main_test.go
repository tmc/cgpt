...
func Test(t *testing.T) {
	...
	testCases := []struct {
		...
		{name: "dummy with stop sequence", backend: "dummy", model: "dummy-model", args: []string{"--prefill=```test", "--stop-sequence=```", "--prefill-echo=false"}},
		{name: "dummy with vimrc stop sequence", backend: "dummy", model: "dummy-model", args: []string{"--prefill=```vimrc", "--stop-sequence=```", "--prefill-echo=false", "--system-prompt=you are a vimrc expert"}},
